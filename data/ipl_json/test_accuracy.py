...
print("Building standardised features...")
final_data = []
...
print(f"Standardised Model Test Accuracy: {test_acc * 100:.2f}%")
print(f"Standardised Model CV Accuracy: {cv_scores.mean() * 100:.2f}% (+/- {cv_scores.std() * 100:.2f}%)")
